...
func NewRouter(deps Dependencies) chi.Router {
	...
	r.Route("/internal/v1", func(r chi.Router) {
		...
		r.Group(func(r chi.Router) {
			...
			// Seller Catalog & Order Authoring (P5.8)
			r.Get("/stores/{storeID}/products", server.handleListStoreProducts)
			r.Post("/stores/{storeID}/products", server.handleCreateStoreProduct)
			r.Get("/stores/{storeID}/products/{productID}", server.handleGetStoreProduct)
			r.Put("/stores/{storeID}/products/{productID}", server.handleUpdateStoreProduct)
			r.Post("/stores/{storeID}/products/{productID}/variants", server.handleCreateProductVariant)
			r.Put("/stores/{storeID}/products/{productID}/variants/{variantID}", server.handleUpdateProductVariant)
			r.Post("/stores/{storeID}/products/{productID}/variants/{variantID}/skus", server.handleCreateVariantSKU)
			r.Put("/stores/{storeID}/products/{productID}/variants/{variantID}/skus/{skuID}", server.handleUpdateVariantSKU)
			r.Post("/stores/{storeID}/products/{productID}/media/uploads", server.handlePresignMediaUpload)
			r.Post("/stores/{storeID}/products/{productID}/media", server.handleCompleteMediaUpload)
			r.Put("/stores/{storeID}/products/{productID}/media/{mediaID}", server.handleUpdateProductMedia)
			r.Delete("/stores/{storeID}/products/{productID}/media/{mediaID}", server.handleDeleteProductMedia)
			r.Get("/stores/{storeID}/locations", server.handleListStoreLocations)
			...
			r.Post("/stores/{storeID}/products/{productID}/unpublish", server.handleUnpublishStoreProduct)
